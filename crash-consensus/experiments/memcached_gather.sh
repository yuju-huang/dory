...
do
    ...
    memcached/bin/memcached-puts-only $key_size $value_size machine1 6379
    sleep 5
...
do
    ...
    memcached/bin/memcached-gets-only $key_size $value_size machine1 6379
    sleep 5
...
do
    ...
    memcached/bin/memcached-puts-gets $key_size $value_size machine1 6379
    sleep 5
