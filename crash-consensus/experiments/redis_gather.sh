...
do
    ...
    redis/bin/redis-puts-only $key_size $value_size machine1 6379
    sleep 5
...
do
    ...
    redis/bin/redis-gets-only $key_size $value_size machine1 6379
    sleep 5
...
do
    ...
    redis/bin/redis-puts-gets $key_size $value_size machine1 6379
    sleep 5
